              ...
              {rows?.slice(0, 3).map((item: any, index: any) => {
                return (<div key={index} className="border-t border-b flex px-4 py-[9px] items-center justify-center dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                  <div className="basis-2/12">
                    <span className="bg-primary-100 text-primary-800 text-xs xl:test-sm font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">
                      {index + 1}
                    </span>
                  </div>
                  ...
                  <div className="py-1 basis-3/12 font-medium text-gray-900 whitespace-nowrap dark:text-white md:text-xs xl:text-sm">
                    <span className="text-xs 2xl:text-sm">
                      {item?.info?.name?.slice(0, 8)}
                    </span>
                  </div>
                  <div className="py-2 basis-3/12 font-medium text-gray-900 whitespace-nowrap dark:text-white lg:text-sm xl:text-sm">
                    <span className="text-xs 2xl:test-sm">
                      {item?.info?.symbol}
                    </span>
                  </div>
                  <div className="py-1 basis-2/12 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <span className="text-xs 2xl:test-sm">
