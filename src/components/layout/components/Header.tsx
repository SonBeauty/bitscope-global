...
export default function Header({ sidebarOpen, setSidebarOpen }: any) {
  return (
    <header className="sticky top-0 z-[999] flex w-full bg-white shadow-xl dark:bg-boxdark dark:drop-shadow-none">
      <div className="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
          <button
            ...
            className="z-[99999] block rounded-sm border border-slate-100 bg-white p-1.5 shadow-sm dark:border-slate-300 dark:bg-slate-300 lg:hidden"
          >
          ...
          <form action="" method="POST">
            <div className="relative">
              <button className="absolute left-0 top-1/2 -translate-y-1/2">
                <svg
                  className="fill-body hover:fill-slate-200 dark:fill-slate-200 dark:hover:fill-slate-200"
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
                  fill="none"
              ...
              <input
                ...
                className="w-full bg-transparent pl-9 pr-4 focus:outline-none rounded-xl"
              />
            </div>
          </form>
        </div>
