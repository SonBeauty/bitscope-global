...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: any) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-[9999] flex h-screen w-72.5 flex-col overflow-y-hidden bg-white duration-300 ease-linear dark:bg-white lg:static lg:translate-x-0 ${
    ...
    >
      ...
      <div className="bg-white no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
                    ...
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <Link href="/forms/form-layout">Form Layout</Link>
                          </li>
                        </ul>
                      </div>
                    </React.Fragment>
