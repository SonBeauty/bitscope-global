  ...
  return (
    <div className="!h-screen !w-screen !overflow-hidden flex flex-col">
      <div className="basis-11/12">
        ...
        <div className={clsx(styles.sand, "!overflow-hidden")}>
        ...
        <div className={styles.text}>
          <h1 className={`${styles.title} !text-black md:!text-white`}>
            ...
            <em className="text-black md:text-white">COMMING SOON</em>
          </h1>
          <Link
            href="/"
            className="p hover:text-white cursor-pointer text-black md:text-white flex gap-3 px-6 items-center justify-center "
          >
      ...
      <div className="home-wave-bottom basis-1/12 w-screen z-[9999999999]">
        <svg
          className="waves"
